...
const categories = [
  { id: "all", label: "Все лиги", icon: iconCup },
  { id: "football", label: "Футбол", icon: iconFootball },
  { id: "basketball", label: "Баскетбол", icon: iconBasketball },
  { id: "hockey", label: "Хоккей", icon: iconHockey },
  { id: "cs2", label: "Counter-Strike 2", icon: iconCs2 },
];
