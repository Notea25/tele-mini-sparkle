...
const FormationFieldTransfers = ({ 
  ...
  const renderPlayer = (player: PlayerData) => (
    <div
      className="w-[62px] aspect-[4/5] relative flex flex-col items-center cursor-pointer border border-white/60 rounded-md overflow-hidden bg-[#3a5a28]/40 backdrop-blur-[2px]"
