        ...
        return (
          ...
          >
            {isOccupied ? (
              ...
              >
                {/* Price and delete button on same row */}
                <div className="w-full flex items-center justify-center relative py-1">
                  <span className="text-white text-[11px] font-bold drop-shadow-md whitespace-nowrap">
                  ...
                  {onRemovePlayer && (
                    <button
                      ...
                      className="absolute right-1 z-50 w-4 h-4 flex items-center justify-center bg-[#4a4a5a] rounded-full"
                    >
