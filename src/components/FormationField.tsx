        ...
        return (
          ...
          >
            {isOccupied ? (
              ...
              <div
                className="w-[62px] h=[44px] relative flex flex-col items-center cursor-pointer border border-white/60 rounded-md overflow-hidden bg-[#3a5a28]/40 backdrop-blur-[2px]"
