        ...
        {activeTab === "leagues" && (
          <>
            ...
            <p className="text-muted-foreground text-sm mb-4">
              Участвуя в коммерческих лигах, вы боретесь за призы в 10 трёхтуровых отрезках сезона. В каждом отрезке
              побеждает участник, набравший максимум очков именно в этих трёх турах, и получает приз от спонсора.
              Считаются только очки внутри отрезка.
            </p>
