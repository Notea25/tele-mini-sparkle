      ...
      <div className="px-4 mt-6 space-y-3">
        ...
        <div className="relative">
          <Input
            ...
            className={`h-[40px] font-rubik font-normal not-italic text-[12px] leading-[130%] tracking-normal rounded-xl bg-[#1A1924] border border-[#363546] placeholder:text-[#4B485F] transition-colors duration-200 ${
